...
local text = {
	"AnyDesk/UltraViewer/etc.","Windows key + R","Open Your Chrome","Kit Redeems Card","Google Play Card", "Target Gift Card",
	...
	"Zelle","Shut Up","Porn Hub","Another Scammer Talking In Background","I Cup"
}
